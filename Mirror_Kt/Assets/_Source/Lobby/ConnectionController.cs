...
public class ConnectionController : NetworkBehaviour
{
    ...
    [SerializeField] private GameObject localPlayerLobbyUI;
    ...
    [SerializeField] private int ChangeNameCost;
    ...
    private void Start()
    {
        ...
        if (index == PlayerPrefs.GetInt("index"))
        {
            ...
            ChooseButton.GetComponentInChildren<TextMeshProUGUI>().text = "Chosen";
        }
        else
        {
            if (Characters[index].purchased == 0)
            {
                ...
                ChooseButton.GetComponentInChildren<TextMeshProUGUI>().text = Characters[index].Cost + "C";
            ...
            else
            {
                ChooseButton.GetComponent<Image>().color = Color.white;
                ChooseButton.interactable = true;
                ChooseButton.GetComponentInChildren<TextMeshProUGUI>().text = "Choose";
            }
        }
    ...
    private void Update()
    {
        if (!inGame)
        {
            ...
            {
                SetNameButton.GetComponentInChildren<TextMeshProUGUI>().text = ChangeNameCost + "C";
